...
The array will always have at least 2 elements and all elements will be numbers. The numbers will also all be unique and in ascending order. The 
...
function firstNonConsecutive (arr) {
  const res = arr.find((n,ind) => n !== ind + arr[0])
